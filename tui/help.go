...
func (h helpModel) view(w, height int, bg string) string {
	...
	lines := []string{
		...
		helpLine("? help", "F2 corkboard", "F3 outliner", "F4 timeline", "F5 panel", "F6 read", "F7 sprint", "F8 theme", "^F search", "F11 bookmarks"),
		"",
		...
		helpLine("Tab binder", "^S save", "^N new scene", "^O outline", "^E export", "^H history"),
		"",
